<div>
    ...
    <img class="gitlab-avatar" src='{{mrAuthorAvatar_url}}'/>
    <span id='th_up_{{mrId}}'>{{mrUpvotes}}</span>
    <svg data-iid='{{mrIid}}' data-projectid='{{mrProject_id}}' class="gitlab-svg" data_award_id_up id='up_{{mrId}}'
    ...
    <svg data-iid='{{mrIid}}' data-projectid='{{mrProject_id}}' data_award_id_down id='down_{{mrId}}'
         style='{{fill_down}}' class="gitlab-svg" viewBox='0 0 16 16' xmlns='http://www.w3.org/2000/svg'>
        <path fill-rule='evenodd'
    ...
    <svg class="gitlab-svg" viewBox='0 0 16 16' data-iid='{{mrIid}}' data-projectid='{{mrProject_id}}'
         id='comment_{{mrIid}}' xmlns='http://www.w3.org/2000/svg'>
        <path fill-rule='evenodd'
    ...
    <span class="gitlab-link">
        <a data-link='{{mrWeb_url}}' id='{{mrId}}' style='color:black; cursor: grab;'>{{mrTitle}}</a>
    </span>
<div/>